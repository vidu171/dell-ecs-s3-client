...
import (
	...
	"github.com/vidu171/dell-ecs-s3-client/aws/awsutil"
	...
	"github.com/vidu171/dell-ecs-s3-client/private/protocol/restxml"
...
func GetS3Session(endpoint, id, secret, token string) *session.Session {
	s3Config := &aws.Config{
		Credentials: credentials.NewStaticCredentials(id, secret, token),
		Endpoint:    aws.String(endpoint),
		Region:      aws.String("itsarandomstring"),
	}
